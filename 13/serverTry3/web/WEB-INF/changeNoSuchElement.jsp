...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form action="http://localhost/server/change" method="post">
      ...
      <h4><span class="badge badge-pill badge-warning">Sorry but: ${exception}. If you want to add it go <a href="http://localhost/server/add" class="text-primary" >here</a>.</span></h4>
  </body>
</html>
